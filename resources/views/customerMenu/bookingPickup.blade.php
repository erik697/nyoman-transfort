  ...
  <form action="{{ route('booking.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" name="pickup_location" id="exampleFormControlTextarea1" rows="3" required></textarea>
        </div>
      ...
      {{-- <div class="form-group">
        <label for="exampleInputEmail1">Pickup Time</label>
        <input type="time" class="form-control" name="pickup_time" id="exampleInputEmail1" placeholder="Enter email">
        </div> --}}
